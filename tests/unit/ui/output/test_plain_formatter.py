...
class TestPrintMessage:
    ...
    def test_print_message_basic(self, formatter, mock_stdout):
        """Test printing a basic message."""
        formatter.print_message("Test message")
        assert "Test message" in mock_stdout.output.getvalue()

    def test_print_message_with_newline(self, formatter, mock_stdout):
    ...
    def test_print_message_empty(self, formatter, mock_stdout):
        """Test printing empty message."""
        formatter.print_message("")
        assert mock_stdout.output.getvalue() == "\n"

    def test_print_message_with_special_chars(self, formatter, mock_stdout):
...
class TestPrintTable:
    ...
    def test_print_table_basic(self, formatter, mock_stdout):
    ...
    def test_print_table_with_title(self, formatter, mock_stdout):
    ...
    def test_print_table_with_custom_headers(self, formatter, mock_stdout):
    ...
    def test_print_table_empty_data(self, formatter, mock_stdout):
        """Test printing table with empty data."""
        formatter.print_table([])
        # Should not print anything
        assert mock_stdout.output.getvalue() == ""

    def test_print_table_missing_values(self, formatter, mock_stdout):
    ...
    def test_print_table_column_alignment(self, formatter, mock_stdout):
    ...
    def test_print_table_multiple_rows(self, formatter, mock_stdout):
...
class TestPrintProgress:
    ...
    def test_print_progress_basic(self, formatter, mock_stdout):
    ...
    def test_print_progress_with_description(self, formatter, mock_stdout):
    ...
    def test_print_progress_zero_total(self, formatter, mock_stdout):
    ...
    def test_print_progress_complete(self, formatter, mock_stdout):
    ...
    def test_print_progress_partial(self, formatter, mock_stdout):
...
class TestStatusMessages:
    ...
    def test_print_success(self, formatter, mock_stdout):
    ...
    def test_print_error(self, formatter, mock_stdout):
    ...
    def test_print_warning(self, formatter, mock_stdout):
    ...
    def test_print_info(self, formatter, mock_stdout):
    ...
    def test_status_messages_formatting(self, formatter, mock_stdout):
...
class TestSpecializedMethods:
    ...
    def test_print_check_results(self, formatter, mock_stdout):
    ...
    def test_print_application_list(self, formatter, mock_stdout):
    ...
    def test_print_config_settings(self, formatter, mock_stdout):
    ...
    def test_print_config_settings_empty(self, formatter, mock_stdout):
...
class TestSections:
    ...
    def test_start_section(self, formatter, mock_stdout):
    ...
    def test_end_section(self, formatter, mock_stdout):
    ...
    def test_end_section_without_start(self, formatter, mock_stdout):
        """Test ending section when none is active."""
        formatter.end_section()
        # Should not print anything if no section is active
        assert mock_stdout.output.getvalue() == ""

    def test_section_title_underline_length(self, formatter, mock_stdout):
    ...
    def test_multiple_sections(self, formatter, mock_stdout):
...
class TestFinalize:
    ...
    def test_finalize_returns_none(self, formatter):
        """Test finalize returns None for console output."""
        result = formatter.finalize()
        assert result is None

    def test_finalize_no_side_effects(self, formatter, mock_stdout):
...
class TestColumnWidthCalculation:
    ...
    def test_calculate_column_widths_basic(self, formatter):
    ...
    def test_calculate_column_widths_empty_values(self, formatter):
    ...
    def test_calculate_column_widths_missing_keys(self, formatter):
...
class TestIntegrationScenarios:
    ...
    def test_check_command_output(self, formatter, mock_stdout):
    ...
    def test_list_command_output(self, formatter, mock_stdout):
    ...
    def test_config_command_output(self, formatter, mock_stdout):
    ...
    def test_error_scenario(self, formatter, mock_stdout):
    ...
    def test_progress_workflow(self, formatter, mock_stdout):
    ...
    def test_complete_workflow(self, formatter, mock_stdout):
