...
class TestPrintMessage:
    ...
    def test_print_message_simple(self, rich_formatter, mock_console):
    ...
    def test_print_message_with_kwargs(self, rich_formatter, mock_console):
...
class TestPrintTable:
    ...
    def test_print_table_with_data(self, rich_formatter, mock_console):
    ...
    def test_print_table_empty_data(self, rich_formatter, mock_console):
        """Test printing table with empty data."""
        rich_formatter.print_table([])

        mock_console.print.assert_not_called()

    def test_print_table_with_custom_headers(self, rich_formatter, mock_console):
    ...
    def test_print_table_no_title(self, rich_formatter, mock_console):
...
class TestPrintProgress:
    ...
    def test_print_progress_with_description(self, rich_formatter, mock_console):
    ...
    def test_print_progress_without_description(self, rich_formatter, mock_console):
    ...
    def test_print_progress_zero_total(self, rich_formatter, mock_console):
    ...
    def test_print_progress_complete(self, rich_formatter, mock_console):
...
class TestPrintStyledMessages:
    ...
    def test_print_success(self, rich_formatter, mock_console):
    ...
    def test_print_info(self, rich_formatter, mock_console):
...
class TestSectionManagement:
    ...
    def test_start_section(self, rich_formatter, mock_console):
    ...
    def test_end_section(self, rich_formatter, mock_console):
    ...
    def test_end_section_when_none(self, rich_formatter, mock_console):
...
class TestFinalize:
    ...
    def test_finalize_returns_none(self, rich_formatter):
...
class TestPathWrapping:
    ...
    def test_wrap_path_with_home_replacement(self, mock_home, rich_formatter):
    ...
    def test_wrap_path_long_path(self, rich_formatter):
    ...
    def test_wrap_path_single_part(self, rich_formatter):
    ...
    @patch("appimage_updater.ui.output.rich_formatter.Path.home")
    def test_wrap_path_short_home_path(self, mock_home, rich_formatter):
...
class TestPathWrappingHelpers:
    ...
    def test_replace_home_with_tilde(self, rich_formatter):
    ...
    def test_replace_home_with_tilde_exact_home(self, rich_formatter):
    ...
    def test_replace_home_with_tilde_no_match(self, rich_formatter):
    ...
    def test_replace_home_with_tilde_empty(self, rich_formatter):
        """Test replacing empty path."""
        result = rich_formatter._replace_home_with_tilde("")

        assert result == ""

    def test_path_fits_within_width(self, rich_formatter):
    ...
    def test_is_short_home_path(self, rich_formatter):
    ...
    def test_all_parts_fit(self, rich_formatter):
    ...
    def test_add_ellipsis_if_truncated(self, rich_formatter):
    ...
    def test_add_ellipsis_if_not_truncated(self, rich_formatter):
...
class TestTableHelpers:
    ...
    def test_create_rich_table(self, rich_formatter):
    ...
    def test_determine_table_headers_from_data(self, rich_formatter):
    ...
    def test_determine_table_headers_custom(self, rich_formatter):
...
class TestPrintApplicationList:
    ...
    def test_print_application_list(self, mock_table_factory, rich_formatter, mock_console):
    ...
    @patch("appimage_updater.ui.output.rich_formatter.TableFactory")
    def test_print_application_list_empty(self, mock_table_factory, rich_formatter, mock_console):
...
class TestPrintConfigSettings:
    ...
    def test_print_config_settings(self, rich_formatter, mock_console):
    ...
    def test_print_config_settings_empty(self, rich_formatter, mock_console):
...
class TestDictToCheckResult:
    ...
    def test_dict_to_check_result_success(self, rich_formatter):
    ...
    def test_dict_to_check_result_error(self, rich_formatter):
    ...
    def test_dict_to_check_result_empty_app_name(self, rich_formatter):
    ...
    def test_dict_to_check_result_no_update(self, rich_formatter):
    ...
    def test_dict_to_check_result_with_candidate(self, rich_formatter, mock_update_candidate):
...
class TestPrintCheckResults:
    ...
    def test_print_check_results_success(self, rich_formatter, mock_console):
    ...
    def test_print_check_results_error(self, rich_formatter, mock_console):
    ...
    def test_print_check_results_empty(self, rich_formatter, mock_console):
...
class TestCheckResultsTable:
    ...
    def test_create_check_results_table(self, rich_formatter):
    ...
    def test_add_error_row(self, rich_formatter):
    ...
    def test_add_error_row_disabled(self, rich_formatter):
    ...
    def test_add_success_row(self, rich_formatter, mock_update_candidate):
    ...
    def test_add_success_row_up_to_date(self, rich_formatter):
    ...
    def test_add_no_data_row(self, rich_formatter):
    ...
    def test_add_direct_version_row_update_available(self, rich_formatter):
    ...
    def test_add_direct_version_row_up_to_date(self, rich_formatter):
    ...
    def test_add_no_candidate_row_with_versions(self, rich_formatter):
    ...
    def test_add_no_candidate_row_without_versions(self, rich_formatter):
...
class TestDisplayCheckResultsTable:
    ...
    def test_display_check_results_table_success(self, rich_formatter, mock_console, mock_update_candidate):
    ...
    def test_display_check_results_table_error(self, rich_formatter, mock_console):
    ...
    def test_display_check_results_table_no_candidate(self, rich_formatter, mock_console):
    ...
    def test_display_check_results_table_mixed(self, rich_formatter, mock_console, mock_update_candidate):
...
class TestBuildPathFromParts:
    ...
    def test_build_path_from_parts_all_fit(self, rich_formatter):
    ...
    def test_build_path_from_parts_truncated(self, rich_formatter):
    ...
    def test_build_path_from_parts_empty(self, rich_formatter):
        """Test building path from empty parts."""
        result = rich_formatter._build_path_from_parts([], 50)

        assert result == []

    def test_build_path_from_parts_single(self, rich_formatter):
...
class TestAddParentDirectoriesToPath:
    ...
    def test_add_parent_directories_within_limit(self, rich_formatter):
    ...
    def test_add_parent_directories_exceeds_limit(self, rich_formatter):
...
class TestWrapMultiPartPath:
    ...
    def test_wrap_multi_part_path_short(self, rich_formatter):
    ...
    def test_wrap_multi_part_path_long(self, rich_formatter):
...
class TestWrapSinglePartPath:
    ...
    def test_wrap_single_part_path(self, rich_formatter):
...
class TestProcessPathWrapping:
    ...
    def test_process_path_wrapping_multi_part(self, rich_formatter):
    ...
    def test_process_path_wrapping_single_part(self, rich_formatter):
