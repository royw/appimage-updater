...
class TestSettingTypeCheckers:
    ...
    def test_is_numeric_setting(self):
...
class TestBooleanValueParsing:
    ...
    def test_parse_boolean_value_true_variants(self):
    ...
    def test_parse_boolean_value_false_variants(self):
...
class TestPathSettings:
    ...
    def test_apply_path_setting_download_dir(self, mock_config, mock_console):
    ...
    def test_apply_path_setting_download_dir_with_tilde(self, mock_config, mock_console):
    ...
    def test_apply_path_setting_download_dir_none(self, mock_config, mock_console):
    ...
    def test_apply_path_setting_symlink_dir(self, mock_config, mock_console):
    ...
    def test_apply_path_setting_symlink_dir_none(self, mock_config, mock_console):
    ...
    def test_handle_path_setting(self, mock_config, mock_console):
...
class TestStringSettings:
    ...
    def test_apply_string_setting_symlink_pattern(self, mock_config, mock_console):
    ...
    def test_apply_string_setting_checksum_pattern(self, mock_config, mock_console):
    ...
    def test_handle_string_setting(self, mock_config, mock_console):
...
class TestBooleanSettings:
    ...
    def test_apply_rotation_enabled_setting(self, mock_config, mock_console):
    ...
    def test_apply_symlink_enabled_setting(self, mock_config, mock_console):
    ...
    def test_apply_checksum_enabled_setting(self, mock_config, mock_console):
    ...
    def test_apply_checksum_required_setting(self, mock_config, mock_console):
    ...
    def test_apply_prerelease_setting(self, mock_config, mock_console):
    ...
    def test_apply_auto_subdir_setting(self, mock_config, mock_console):
    ...
    def test_get_boolean_setting_handler_unknown(self):
        """Test getting handler for unknown setting."""
        handler = _get_boolean_setting_handler("unknown")
        assert handler is None

    def test_apply_boolean_setting(self, mock_config, mock_console):
        """Test applying boolean setting."""
        _apply_boolean_setting(mock_config, "rotation", "true")
        assert mock_config.global_config.defaults.rotation_enabled is True
        mock_console.print.assert_called_once()

    def test_handle_boolean_setting(self, mock_config, mock_console):
...
class TestNumericSettings:
    ...
    def test_apply_retain_count_setting_valid(self, mock_config, mock_console):
    ...
    def test_apply_retain_count_setting_min_boundary(self, mock_config, mock_console):
    ...
    def test_apply_retain_count_setting_max_boundary(self, mock_config, mock_console):
    ...
    def test_apply_retain_count_setting_too_low(self, mock_config, mock_console):
    ...
    def test_apply_retain_count_setting_too_high(self, mock_config, mock_console):
    ...
    def test_apply_concurrent_downloads_setting_valid(self, mock_config, mock_console):
    ...
    def test_apply_concurrent_downloads_setting_min_boundary(self, mock_config, mock_console):
    ...
    def test_apply_concurrent_downloads_setting_max_boundary(self, mock_config, mock_console):
    ...
    def test_apply_concurrent_downloads_setting_too_low(self, mock_config, mock_console):
    ...
    def test_apply_concurrent_downloads_setting_too_high(self, mock_config, mock_console):
    ...
    def test_apply_timeout_setting_valid(self, mock_config, mock_console):
    ...
    def test_apply_timeout_setting_min_boundary(self, mock_config, mock_console):
    ...
    def test_apply_timeout_setting_max_boundary(self, mock_config, mock_console):
    ...
    def test_apply_timeout_setting_too_low(self, mock_config, mock_console):
    ...
    def test_apply_timeout_setting_too_high(self, mock_config, mock_console):
    ...
    def test_validate_and_apply_numeric_value_retain_count(self, mock_config, mock_console):
        """Test validating and applying retain count."""
        result = _validate_and_apply_numeric_value(mock_config, "retain-count", 5)
        assert result is True
        assert mock_config.global_config.defaults.retain_count == 5

    def test_validate_and_apply_numeric_value_concurrent_downloads(self, mock_config, mock_console):
    ...
    def test_handle_numeric_setting(self, mock_config, mock_console):
...
class TestChecksumAlgorithmSetting:
    ...
    def test_apply_checksum_algorithm_setting_sha256(self, mock_config, mock_console):
    ...
    def test_apply_checksum_algorithm_setting_sha1(self, mock_config, mock_console):
    ...
    def test_apply_checksum_algorithm_setting_md5(self, mock_config, mock_console):
    ...
    def test_apply_checksum_algorithm_setting_case_insensitive(self, mock_config, mock_console):
        """Test applying algorithm with different case."""
        result = _apply_checksum_algorithm_setting(mock_config, "SHA256")
        assert result is True
        assert mock_config.global_config.defaults.checksum_algorithm == "sha256"

    def test_apply_checksum_algorithm_setting_invalid(self, mock_config, mock_console):
...
class TestSettingHandlers:
    ...
    def test_get_setting_handlers(self):
    ...
    def test_handle_unknown_setting(self, mock_show):
...
class TestApplySettingChange:
    ...
    @patch("appimage_updater.config.cmd.setting_operations._show_available_settings")
    def test_apply_setting_change_unknown(self, mock_show, mock_config, mock_console):
...
class TestIntegrationScenarios:
    ...
    def test_configure_rotation_workflow(self, mock_config, mock_console):
    ...
    def test_configure_checksum_workflow(self, mock_config, mock_console):
    ...
    def test_configure_download_workflow(self, mock_config, mock_console):
    ...
    def test_disable_all_features(self, mock_config, mock_console):
