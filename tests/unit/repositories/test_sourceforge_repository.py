...
class TestParseRepoUrl:
    ...
    def test_parse_valid_url_with_path(self, sf_repo):
    ...
    def test_parse_valid_url_without_path(self, sf_repo):
    ...
    def test_parse_url_without_files_section(self, sf_repo):
    ...
    def test_parse_url_with_trailing_slash(self, sf_repo):
    ...
    def test_parse_empty_url_raises_error(self, sf_repo):
        """Test parsing empty URL raises ValueError."""
        with pytest.raises(ValueError, match="URL cannot be empty"):
            sf_repo.parse_repo_url("")

    def test_parse_whitespace_url_raises_error(self, sf_repo):
        """Test parsing whitespace URL raises ValueError."""
        with pytest.raises(ValueError, match="URL cannot be empty"):
            sf_repo.parse_repo_url("   ")

    def test_parse_invalid_format_raises_error(self, sf_repo):
    ...
    def test_parse_missing_project_raises_error(self, sf_repo):
        """Test parsing URL without project raises RepositoryError."""
        with pytest.raises(RepositoryError, match="Invalid SourceForge URL format"):
            sf_repo.parse_repo_url("https://sourceforge.net/projects/")

    def test_parse_malformed_url_raises_error(self, sf_repo):
...
class TestNormalizeRepoUrl:
    ...
    def test_normalize_removes_trailing_slash(self, sf_repo):
    ...
    def test_normalize_converts_http_to_https(self, sf_repo):
    ...
    def test_normalize_adds_https_protocol(self, sf_repo):
    ...
    def test_normalize_already_normalized(self, sf_repo):
    ...
    def test_normalize_multiple_corrections(self, sf_repo):
...
class TestConvertToDirectDownloadUrl:
    ...
    def test_convert_adds_download_suffix(self, sf_repo):
    ...
    def test_convert_preserves_existing_download_suffix(self, sf_repo):
    ...
    def test_convert_removes_query_parameters(self, sf_repo):
    ...
    def test_convert_non_sourceforge_url_unchanged(self, sf_repo):
    ...
    def test_convert_url_without_files_unchanged(self, sf_repo):
...
class TestExtractFilenameFromUrl:
    ...
    def test_extract_filename_simple(self, sf_repo):
    ...
    def test_extract_filename_with_download_suffix(self, sf_repo):
    ...
    def test_extract_filename_with_trailing_slash(self, sf_repo):
    ...
    def test_extract_filename_from_root(self, sf_repo):
    ...
    def test_extract_filename_complex_path(self, sf_repo):
...
class TestExtractVersionFromAsset:
    ...
    def test_extract_semantic_version(self, sf_repo):
    ...
    def test_extract_version_with_v_prefix(self, sf_repo):
    ...
    def test_extract_date_based_version(self, sf_repo):
    ...
    def test_extract_simple_version(self, sf_repo):
    ...
    def test_extract_version_with_underscore(self, sf_repo):
    ...
    def test_extract_version_fallback_to_filename(self, sf_repo):
...
class TestFindCommonPrefix:
    ...
    def test_find_common_prefix_simple(self, sf_repo):
    ...
    def test_find_common_prefix_case_insensitive(self, sf_repo):
    ...
    def test_find_common_prefix_no_common(self, sf_repo):
    ...
    def test_find_common_prefix_empty_list(self, sf_repo):
        """Test finding common prefix with empty list."""
        prefix = sf_repo._find_common_prefix([])

        assert prefix == ""

    def test_find_common_prefix_single_string(self, sf_repo):
    ...
    def test_find_common_prefix_partial_match(self, sf_repo):
...
class TestGenerateSingleAssetPattern:
    ...
    def test_generate_pattern_with_version(self, sf_repo):
    ...
    def test_generate_pattern_with_v_prefix(self, sf_repo):
    ...
    def test_generate_pattern_no_version(self, sf_repo):
    ...
    def test_generate_pattern_empty_base_name(self, sf_repo):
...
class TestCreatePatternFromPrefix:
    ...
    def test_create_pattern_valid_prefix(self, sf_repo):
    ...
    def test_create_pattern_removes_version(self, sf_repo):
    ...
    def test_create_pattern_strips_trailing_chars(self, sf_repo):
...
class TestGeneratePatternFromNames:
    ...
    def test_generate_pattern_empty_list(self, sf_repo):
        """Test generating pattern from empty list."""
        pattern = sf_repo._generate_pattern_from_names([])

        assert pattern is None

    def test_generate_pattern_single_asset(self, sf_repo):
    ...
    def test_generate_pattern_multiple_assets(self, sf_repo):
...
class TestAsyncMethods:
    ...
    @pytest.mark.anyio
    async def test_get_latest_release_success(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_get_latest_release_no_releases(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_get_latest_release_including_prerelease(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_get_file_size_success(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_get_file_size_no_content_length(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_get_file_size_error(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_extract_appimage_assets(self, sf_repo, mock_html_content):
        ...
        with patch.object(sf_repo, "_get_file_size", new_callable=AsyncMock) as mock_get_size:
            ...
            assets = await sf_repo._extract_appimage_assets(
                mock_html_content, "https://sourceforge.net/projects/test"
            )
    ...
    @pytest.mark.anyio
    async def test_extract_appimage_assets_empty_content(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_should_enable_prerelease_only_prereleases(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_should_enable_prerelease_mixed_releases(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_should_enable_prerelease_no_releases(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_should_enable_prerelease_error(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_generate_pattern_from_releases_success(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_generate_pattern_from_releases_no_releases(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_generate_pattern_from_releases_no_assets(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_generate_pattern_from_releases_error(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_get_releases_http_error(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_get_releases_timeout_error(self, sf_repo):
    ...
    @pytest.mark.anyio
    async def test_fetch_sourceforge_releases_no_appimages(self, sf_repo):
        ...
        with patch("appimage_updater.repositories.sourceforge.repository.get_http_client", return_value=mock_client):
            with pytest.raises(RepositoryError, match="No AppImage downloads found"):
                await sf_repo._fetch_sourceforge_releases(
                    "https://sourceforge.net/projects/test", "test", "", 10
                )
