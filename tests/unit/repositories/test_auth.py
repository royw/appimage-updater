...
class TestGitLabForgeAuth:
    ...
    def test_discover_gitlab_token_from_gitlab_token(self):
    ...
    def test_discover_gitlab_token_from_private_token(self):
    ...
    def test_discover_gitlab_token_from_ci_job_token(self):
    ...
    def test_discover_gitlab_token_priority(self):
        """Test token discovery priority (first found wins)."""
        with patch.dict("os.environ", {
            "GITLAB_TOKEN": "token1",
            "GITLAB_PRIVATE_TOKEN": "token2",
            "CI_JOB_TOKEN": "token3"
        }):
            auth = GitLabForgeAuth(user_agent="TestAgent/1.0")
...
class TestCodebergForgeAuth:
    ...
    def test_discover_codeberg_token_from_codeberg_token(self):
    ...
    def test_discover_codeberg_token_from_gitea_token(self):
    ...
    def test_discover_codeberg_token_from_forgejo_token(self):
    ...
    def test_discover_codeberg_token_priority(self):
        """Test token discovery priority."""
        with patch.dict("os.environ", {
            "CODEBERG_TOKEN": "token1",
            "GITEA_TOKEN": "token2",
            "FORGEJO_TOKEN": "token3"
        }):
            auth = CodebergForgeAuth(user_agent="TestAgent/1.0")
...
class TestDynamicForgeAuth:
    ...
    def test_get_auth_for_url_github(self):
    ...
    def test_get_auth_for_url_gitlab(self):
    ...
    def test_get_auth_for_url_codeberg(self):
    ...
    def test_get_auth_for_url_self_hosted_gitlab(self):
    ...
    def test_get_auth_for_url_unknown_forge(self):
    ...
    def test_get_auth_for_url_caching(self):
    ...
    def test_create_generic_auth_with_token(self):
    ...
    def test_create_generic_auth_without_token(self):
    ...
    def test_create_generic_auth_domain_cleaning(self):
...
class TestIntegrationScenarios:
    ...
    def test_multiple_forge_authentication(self):
    ...
    def test_auth_cache_efficiency(self):
    ...
    def test_mixed_authenticated_and_anonymous(self):
