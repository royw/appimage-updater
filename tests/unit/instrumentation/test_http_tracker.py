...
from appimage_updater.instrumentation.http_tracker import (
    HTTPRequestRecord,
    HTTPTracker,
)
...
class TestHTTPTrackerInitialization:
    ...
    def test_initialization_custom_stack_depth(self, silent_logger):
        """Test tracker with custom stack depth."""
        tracker = HTTPTracker(stack_depth=5, logger=silent_logger)
        
        assert tracker.stack_depth == 5

    def test_initialization_with_header_tracking(self, silent_logger):
...
class TestHTTPTrackerStartStop:
    ...
    def test_stop_tracking_not_active(self, tracker):
...
class TestCallStackCapture:
    ...
    def test_capture_call_stack(self, tracker):
    ...
    def test_stack_depth_limit(self, silent_logger):
    ...
    def test_extract_short_filename(self, tracker):
    ...
    def test_create_stack_entry(self, tracker):
...
class TestResponseHandling:
    ...
    def test_record_response_details_with_status(self, tracker):
    ...
    def test_record_response_details_without_status(self, tracker):
    ...
    def test_handle_request_error(self, tracker):
...
class TestLoggingIntegration:
    ...
    def test_log_successful_request_without_timing(self, tracker):
...
class TestEdgeCases:
    ...
    def test_skip_internal_frames(self, tracker):
