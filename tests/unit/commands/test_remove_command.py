...
class TestRemoveCommand:
    ...
    @pytest.mark.anyio
    async def test_execute_remove_operation_success(self):
    ...
    @pytest.mark.anyio
    async def test_execute_remove_operation_config_load_error(self):
    ...
    @pytest.mark.anyio
    async def test_process_removal_workflow_success(self):
    ...
    @pytest.mark.anyio
    async def test_process_removal_workflow_no_applications(self):
    ...
    @pytest.mark.anyio
    async def test_process_removal_workflow_no_matching_apps(self):
    ...
    @pytest.mark.anyio
    async def test_process_removal_workflow_user_cancellation(self):
    ...
    def test_should_proceed_with_removal_user_confirmation(self):
