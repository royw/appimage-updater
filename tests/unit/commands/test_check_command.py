...
class TestCheckCommand:
                ...
                with patch.object(command, '_stop_http_tracking') as mock_stop:
                    with patch.object(command, '_display_http_tracking_summary') as mock_display:
                        result = await command.execute(
                            http_tracker=mock_http_tracker,
    ...
    def test_display_request_count(self):
        ...
        mock_formatter.print.assert_called_once_with("Total requests: 3")
    ...
    def test_display_request_details_few_requests(self):
        ...
        mock_formatter.print.assert_has_calls(expected_calls)
    ...
    def test_display_request_details_many_requests(self):
        ...
        assert mock_formatter.print.call_count == 5
        mock_remaining.assert_called_once_with(mock_tracker, mock_formatter)
    ...
    def test_display_remaining_count_with_remaining(self):
        ...
        mock_formatter.print.assert_called_once_with("  ... and 3 more requests")
    ...
    def test_display_remaining_count_no_remaining(self):
        ...
        mock_formatter.print.assert_not_called()
