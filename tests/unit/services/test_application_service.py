...
class TestFilterAppsByNames:
    ...
    def test_filter_empty_app_names(self):
    ...
    def test_filter_exact_match_single(self):
    ...
    def test_filter_exact_match_case_insensitive(self):
    ...
    def test_filter_multiple_exact_matches(self):
    ...
    def test_filter_glob_pattern_wildcard(self):
    ...
    def test_filter_glob_pattern_question_mark(self):
    ...
    def test_filter_not_found_returns_none(self):
...
class TestFilterAppsBySingleName:
    ...
    def test_exact_match_preferred_over_glob(self):
    ...
    def test_glob_match_when_no_exact_match(self):
...
class TestFindExactMatches:
    ...
    def test_find_no_exact_match(self):
    ...
    def test_find_multiple_exact_matches(self):
...
class TestFindGlobMatches:
    ...
    def test_find_glob_matches_wildcard(self):
    ...
    def test_find_glob_matches_question_mark(self):
    ...
    def test_find_glob_matches_character_class(self):
...
class TestCollectAppMatches:
    ...
    def test_collect_all_found(self):
    ...
    def test_collect_some_not_found(self):
    ...
    def test_collect_all_not_found(self):
...
class TestHandleAppsNotFound:
    ...
    def test_handle_with_formatter(self):
    ...
    def test_handle_without_formatter(self):
    ...
    def test_handle_includes_available_apps(self):
...
class TestPrintTroubleshootingTipsFormatted:
    ...
    def test_print_with_available_apps(self):
    ...
    def test_print_without_available_apps(self):
...
class TestIntegrationScenarios:
    ...
    def test_case_insensitive_glob_matching(self):
    ...
    def test_error_handling_with_partial_matches(self):
