...
class TestNormalizeVersionString:
    ...
    def test_remove_v_prefix_lowercase(self):
        """Test removing lowercase 'v' prefix."""
        assert normalize_version_string("v2.3.1") == "2.3.1"

    def test_remove_v_prefix_uppercase(self):
    ...
    def test_complex_version_with_v_prefix(self):
...
class TestFormatVersionDisplay:
    ...
    def test_date_format_already_formatted(self):
...
class TestCreateNightlyVersion:
    ...
    def test_create_nightly_version_basic(self):
    ...
    def test_create_nightly_version_different_date(self):
    ...
    def test_create_nightly_version_jan_first(self):
    ...
    def test_create_nightly_version_dec_last(self):
    ...
    def test_create_nightly_version_leap_year(self):
...
class TestExtractVersionFromFilename:
    ...
    def test_extract_version_with_alpha(self):
    ...
    def test_extract_version_with_rc(self):
    ...
    def test_extract_version_two_part_with_beta(self):
    ...
    def test_extract_version_date_in_middle(self):
...
class TestIntegrationScenarios:
    ...
    def test_filename_extraction_workflow(self):
    ...
    def test_complete_version_pipeline(self):
    ...
    def test_date_version_pipeline(self):
